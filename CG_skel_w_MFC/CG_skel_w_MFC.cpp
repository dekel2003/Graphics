...
Scene *scene;
Renderer *renderer;
int menuMesh, colorMenu, mainMenuRef, menuCamera, menuLight, menuShadow, menuTexture, menuNormalMapping, menuFog, menuSsaa, menuView, menuVertexNormals, menuFaceNormals, menuBoundingBox;
char c[2];
int last_x,last_y;
